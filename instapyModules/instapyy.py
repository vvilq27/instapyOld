...
class InstaPy:
    ...
    def __init__(self,
        ...
        bypass_with_mobile = bypass_with_mobile
        split_db = split_db
    ...
    def like_by_tags(self,
        ...
        for index, tag in enumerate(tags):
            ...
            for i, link in enumerate(links):
                ...
                self.logger.info('[ARO] Like# [{}/{}]'.format(i + 1, len(links)))
                self.logger.info(link)
                ...
                try:
                    ...
                    # check if post likes count is between min-max (bounds set by user) not useful
                    if not inappropriate and self.delimit_liking:
                        self.liking_approved = verify_liking(self.browser,
                                                             self.max_likes,
                                                             self.min_likes,
